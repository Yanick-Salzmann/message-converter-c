...
class  SwiftMtParser_MT398Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT398Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT398Parser();
  ...
  public:
      typedef SwiftMtParser_MT398Lexer tLexer;
      typedef SwiftMtParser_MT398Parser tParser;
