...
SwiftMtParser_MT507Lexer::SwiftMtParser_MT507Lexer(CharStream *input) : Lexer(input) {
  _interpreter = new atn::LexerATNSimulator(this, _atn, _decisionToDFA, _sharedContextCache);
}

SwiftMtParser_MT507Lexer::~SwiftMtParser_MT507Lexer() {
  delete _interpreter;
}

std::string SwiftMtParser_MT507Lexer::getGrammarFileName() const {
  return "SwiftMtParser_MT507.g4";
}

const std::vector<std::string>& SwiftMtParser_MT507Lexer::getRuleNames() const {
  return _ruleNames;
}

const std::vector<std::string>& SwiftMtParser_MT507Lexer::getChannelNames() const {
  return _channelNames;
}

const std::vector<std::string>& SwiftMtParser_MT507Lexer::getModeNames() const {
  return _modeNames;
}

const std::vector<std::string>& SwiftMtParser_MT507Lexer::getTokenNames() const {
  return _tokenNames;
}

dfa::Vocabulary& SwiftMtParser_MT507Lexer::getVocabulary() const {
  return _vocabulary;
}

const std::vector<uint16_t> SwiftMtParser_MT507Lexer::getSerializedATN() const {
  return _serializedATN;
}

const atn::ATN& SwiftMtParser_MT507Lexer::getATN() const {
  return _atn;
}
...
std::vector<dfa::DFA> SwiftMtParser_MT507Lexer::_decisionToDFA;
atn::PredictionContextCache SwiftMtParser_MT507Lexer::_sharedContextCache;

// We own the ATN which in turn owns the ATN states.
atn::ATN SwiftMtParser_MT507Lexer::_atn;
std::vector<uint16_t> SwiftMtParser_MT507Lexer::_serializedATN;

std::vector<std::string> SwiftMtParser_MT507Lexer::_ruleNames = {
...
std::vector<std::string> SwiftMtParser_MT507Lexer::_channelNames = {
  "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
};

std::vector<std::string> SwiftMtParser_MT507Lexer::_modeNames = {
  u8"DEFAULT_MODE"
};

std::vector<std::string> SwiftMtParser_MT507Lexer::_literalNames = {
  "", u8"'16R:'", u8"'16S:'", u8"'20C:'", u8"'23G:'", u8"'22F:'", u8"'98A:'", 
  u8"'13B:'", u8"'70C:'", u8"'98C:'", u8"'98E:'", u8"'22H:'", u8"'95P:'", 
  u8"'95Q:'", u8"'95R:'", u8"'25D:'", u8"'24B:'", u8"'70D:'", u8"'13A:'", 
  u8"'{1:'", u8"'{2:'", u8"'{3:'", u8"'{4:'", u8"'{5:'", u8"'-}'", u8"'{'", 
  u8"'}'", u8"':'"
};

std::vector<std::string> SwiftMtParser_MT507Lexer::_symbolicNames = {
  "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", 
  "", u8"TAG_BH", u8"TAG_AH", u8"TAG_UH", u8"TAG_MT", u8"TAG_TR", u8"MT_END", 
  u8"LBRACE", u8"RBRACE", u8"COLON", u8"START_OF_FIELD", u8"ANY"
};

dfa::Vocabulary SwiftMtParser_MT507Lexer::_vocabulary(_literalNames, _symbolicNames);

std::vector<std::string> SwiftMtParser_MT507Lexer::_tokenNames;

SwiftMtParser_MT507Lexer::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x2, 0x83, 0x84, 0x7, 0x34, 0x2, 0x2, 0x84, 0x85, 0x7, 0x37, 0x2, 0x2, 
    0x85, 0x86, 0x7, 0x46, 0x2, 0x2, 0x86, 0x87, 0x7, 0x3c, 0x2, 0x2, 0x87, 
    0x20, 0x3, 0x2, 0x2, 0x2, 0x88, 0x89, 0x7, 0x34, 0x2, 0x2, 0x89, 0x8a, 
    0x7, 0x36, 0x2, 0x2, 0x8a, 0x8b, 0x7, 0x44, 0x2, 0x2, 0x8b, 0x8c, 0x7, 
    0x3c, 0x2, 0x2, 0x8c, 0x22, 0x3, 0x2, 0x2, 0x2, 0x8d, 0x8e, 0x7, 0x39, 
    0x2, 0x2, 0x8e, 0x8f, 0x7, 0x32, 0x2, 0x2, 0x8f, 0x90, 0x7, 0x46, 0x2, 
    0x2, 0x90, 0x91, 0x7, 0x3c, 0x2, 0x2, 0x91, 0x24, 0x3, 0x2, 0x2, 0x2, 
    0x92, 0x93, 0x7, 0x33, 0x2, 0x2, 0x93, 0x94, 0x7, 0x35, 0x2, 0x2, 0x94, 
    0x95, 0x7, 0x43, 0x2, 0x2, 0x95, 0x96, 0x7, 0x3c, 0x2, 0x2, 0x96, 0x26, 
...
SwiftMtParser_MT507Lexer::Initializer SwiftMtParser_MT507Lexer::_init;
