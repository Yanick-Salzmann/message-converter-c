...
class  SwiftMtParser_MTn98Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MTn98Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MTn98Parser();
  ...
  public:
      typedef SwiftMtParser_MTn98Lexer tLexer;
      typedef SwiftMtParser_MTn98Parser tParser;
