...
class  SwiftMtParser_MT752Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT752Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT752Parser();
  ...
  public:
      typedef SwiftMtParser_MT752Lexer tLexer;
      typedef SwiftMtParser_MT752Parser tParser;
