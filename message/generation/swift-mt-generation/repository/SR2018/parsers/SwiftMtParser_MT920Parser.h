...
class  SwiftMtParser_MT920Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT920Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT920Parser();
  ...
  public:
      typedef SwiftMtParser_MT920Lexer tLexer;
      typedef SwiftMtParser_MT920Parser tParser;
