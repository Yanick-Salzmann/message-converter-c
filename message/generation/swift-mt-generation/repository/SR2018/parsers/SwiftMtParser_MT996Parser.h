...
class  SwiftMtParser_MT996Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT996Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT996Parser();
  ...
  public:
      typedef SwiftMtParser_MT996Lexer tLexer;
      typedef SwiftMtParser_MT996Parser tParser;
