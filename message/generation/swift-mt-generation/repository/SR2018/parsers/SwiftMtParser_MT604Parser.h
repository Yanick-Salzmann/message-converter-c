...
class  SwiftMtParser_MT604Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT604Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT604Parser();
  ...
  public:
      typedef SwiftMtParser_MT604Lexer tLexer;
      typedef SwiftMtParser_MT604Parser tParser;
