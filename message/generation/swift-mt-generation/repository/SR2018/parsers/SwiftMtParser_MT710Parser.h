...
class  SwiftMtParser_MT710Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT710Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT710Parser();
  ...
  public:
      typedef SwiftMtParser_MT710Lexer tLexer;
      typedef SwiftMtParser_MT710Parser tParser;
