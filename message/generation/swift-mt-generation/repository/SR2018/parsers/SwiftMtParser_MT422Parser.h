...
class  SwiftMtParser_MT422Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT422Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT422Parser();
  ...
  public:
      typedef SwiftMtParser_MT422Lexer tLexer;
      typedef SwiftMtParser_MT422Parser tParser;
