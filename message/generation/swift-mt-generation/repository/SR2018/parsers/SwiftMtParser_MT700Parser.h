...
class  SwiftMtParser_MT700Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT700Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT700Parser();
  ...
  public:
      typedef SwiftMtParser_MT700Lexer tLexer;
      typedef SwiftMtParser_MT700Parser tParser;
