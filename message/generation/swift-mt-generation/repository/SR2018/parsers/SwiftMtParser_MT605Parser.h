...
class  SwiftMtParser_MT605Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT605Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT605Parser();
  ...
  public:
      typedef SwiftMtParser_MT605Lexer tLexer;
      typedef SwiftMtParser_MT605Parser tParser;
