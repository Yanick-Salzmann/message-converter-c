...
class  SwiftMtParser_MT891Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT891Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT891Parser();
  ...
  public:
      typedef SwiftMtParser_MT891Lexer tLexer;
      typedef SwiftMtParser_MT891Parser tParser;
