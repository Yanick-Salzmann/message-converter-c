...
class  SwiftMtParser_MT101Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT101Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT101Parser();
  ...
  public:
      typedef SwiftMtParser_MT101Lexer tLexer;
      typedef SwiftMtParser_MT101Parser tParser;
