...
class  SwiftMtParser_MT791Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT791Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT791Parser();
  ...
  public:
      typedef SwiftMtParser_MT791Lexer tLexer;
      typedef SwiftMtParser_MT791Parser tParser;
