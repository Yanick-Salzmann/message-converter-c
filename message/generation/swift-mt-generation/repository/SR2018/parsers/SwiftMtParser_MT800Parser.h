...
class  SwiftMtParser_MT800Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT800Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT800Parser();
  ...
  public:
      typedef SwiftMtParser_MT800Lexer tLexer;
      typedef SwiftMtParser_MT800Parser tParser;
