...
class  SwiftMtParser_MTn90Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MTn90Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MTn90Parser();
  ...
  public:
      typedef SwiftMtParser_MTn90Lexer tLexer;
      typedef SwiftMtParser_MTn90Parser tParser;
