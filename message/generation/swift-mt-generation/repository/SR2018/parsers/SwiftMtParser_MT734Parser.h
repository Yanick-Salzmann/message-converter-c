...
class  SwiftMtParser_MT734Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT734Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT734Parser();
  ...
  public:
      typedef SwiftMtParser_MT734Lexer tLexer;
      typedef SwiftMtParser_MT734Parser tParser;
