...
class  SwiftMtParser_MT204Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT204Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT204Parser();
  ...
  public:
      typedef SwiftMtParser_MT204Lexer tLexer;
      typedef SwiftMtParser_MT204Parser tParser;
