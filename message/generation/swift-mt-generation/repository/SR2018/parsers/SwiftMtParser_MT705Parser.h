...
class  SwiftMtParser_MT705Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT705Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT705Parser();
  ...
  public:
      typedef SwiftMtParser_MT705Lexer tLexer;
      typedef SwiftMtParser_MT705Parser tParser;
