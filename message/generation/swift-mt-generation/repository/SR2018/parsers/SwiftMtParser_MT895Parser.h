...
class  SwiftMtParser_MT895Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT895Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT895Parser();
  ...
  public:
      typedef SwiftMtParser_MT895Lexer tLexer;
      typedef SwiftMtParser_MT895Parser tParser;
