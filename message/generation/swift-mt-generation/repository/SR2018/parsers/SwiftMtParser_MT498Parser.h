...
class  SwiftMtParser_MT498Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT498Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT498Parser();
  ...
  public:
      typedef SwiftMtParser_MT498Lexer tLexer;
      typedef SwiftMtParser_MT498Parser tParser;
