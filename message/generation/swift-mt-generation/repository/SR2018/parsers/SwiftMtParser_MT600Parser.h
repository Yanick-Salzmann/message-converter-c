...
class  SwiftMtParser_MT600Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT600Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT600Parser();
  ...
  public:
      typedef SwiftMtParser_MT600Lexer tLexer;
      typedef SwiftMtParser_MT600Parser tParser;
