...
SwiftMtParser_MT306Lexer::SwiftMtParser_MT306Lexer(CharStream *input) : Lexer(input) {
  _interpreter = new atn::LexerATNSimulator(this, _atn, _decisionToDFA, _sharedContextCache);
}

SwiftMtParser_MT306Lexer::~SwiftMtParser_MT306Lexer() {
  delete _interpreter;
}

std::string SwiftMtParser_MT306Lexer::getGrammarFileName() const {
  return "SwiftMtParser_MT306.g4";
}

const std::vector<std::string>& SwiftMtParser_MT306Lexer::getRuleNames() const {
  return _ruleNames;
}

const std::vector<std::string>& SwiftMtParser_MT306Lexer::getChannelNames() const {
  return _channelNames;
}

const std::vector<std::string>& SwiftMtParser_MT306Lexer::getModeNames() const {
  return _modeNames;
}

const std::vector<std::string>& SwiftMtParser_MT306Lexer::getTokenNames() const {
  return _tokenNames;
}

dfa::Vocabulary& SwiftMtParser_MT306Lexer::getVocabulary() const {
  return _vocabulary;
}

const std::vector<uint16_t> SwiftMtParser_MT306Lexer::getSerializedATN() const {
  return _serializedATN;
}

const atn::ATN& SwiftMtParser_MT306Lexer::getATN() const {
  return _atn;
}
...
std::vector<dfa::DFA> SwiftMtParser_MT306Lexer::_decisionToDFA;
atn::PredictionContextCache SwiftMtParser_MT306Lexer::_sharedContextCache;

// We own the ATN which in turn owns the ATN states.
atn::ATN SwiftMtParser_MT306Lexer::_atn;
std::vector<uint16_t> SwiftMtParser_MT306Lexer::_serializedATN;

std::vector<std::string> SwiftMtParser_MT306Lexer::_ruleNames = {
  u8"TAG_BH", u8"TAG_AH", u8"TAG_UH", u8"TAG_MT", u8"TAG_TR", u8"MT_END", 
  u8"LBRACE", u8"RBRACE", u8"COLON", u8"START_OF_FIELD", u8"ANY"
};

std::vector<std::string> SwiftMtParser_MT306Lexer::_channelNames = {
  "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
};

std::vector<std::string> SwiftMtParser_MT306Lexer::_modeNames = {
  u8"DEFAULT_MODE"
};

std::vector<std::string> SwiftMtParser_MT306Lexer::_literalNames = {
  "", u8"'{1:'", u8"'{2:'", u8"'{3:'", u8"'{4:'", u8"'{5:'", u8"'-}'", u8"'{'", 
  u8"'}'", u8"':'"
};

std::vector<std::string> SwiftMtParser_MT306Lexer::_symbolicNames = {
  "", u8"TAG_BH", u8"TAG_AH", u8"TAG_UH", u8"TAG_MT", u8"TAG_TR", u8"MT_END", 
  u8"LBRACE", u8"RBRACE", u8"COLON", u8"START_OF_FIELD", u8"ANY"
};

dfa::Vocabulary SwiftMtParser_MT306Lexer::_vocabulary(_literalNames, _symbolicNames);

std::vector<std::string> SwiftMtParser_MT306Lexer::_tokenNames;

SwiftMtParser_MT306Lexer::Initializer::Initializer() {
...
SwiftMtParser_MT306Lexer::Initializer SwiftMtParser_MT306Lexer::_init;
