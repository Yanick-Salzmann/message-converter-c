...
class  SwiftMtParser_MT304Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT304Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT304Parser();
  ...
  public:
      typedef SwiftMtParser_MT304Lexer tLexer;
      typedef SwiftMtParser_MT304Parser tParser;
