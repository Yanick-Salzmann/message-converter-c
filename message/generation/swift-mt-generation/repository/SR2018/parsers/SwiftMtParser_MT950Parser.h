...
class  SwiftMtParser_MT950Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT950Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT950Parser();
  ...
  public:
      typedef SwiftMtParser_MT950Lexer tLexer;
      typedef SwiftMtParser_MT950Parser tParser;
