...
class  SwiftMtParser_MT795Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT795Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT795Parser();
  ...
  public:
      typedef SwiftMtParser_MT795Lexer tLexer;
      typedef SwiftMtParser_MT795Parser tParser;
