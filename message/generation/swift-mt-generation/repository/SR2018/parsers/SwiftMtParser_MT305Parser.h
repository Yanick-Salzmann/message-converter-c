...
class  SwiftMtParser_MT305Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT305Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT305Parser();
  ...
  public:
      typedef SwiftMtParser_MT305Lexer tLexer;
      typedef SwiftMtParser_MT305Parser tParser;
