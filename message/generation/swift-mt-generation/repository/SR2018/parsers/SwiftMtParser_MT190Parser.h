...
class  SwiftMtParser_MT190Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT190Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT190Parser();
  ...
  public:
      typedef SwiftMtParser_MT190Lexer tLexer;
      typedef SwiftMtParser_MT190Parser tParser;
