...
class  SwiftMtParser_MT590Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT590Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT590Parser();
  ...
  public:
      typedef SwiftMtParser_MT590Lexer tLexer;
      typedef SwiftMtParser_MT590Parser tParser;
