...
seq_A                  returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("A"); } :
                       ...
                       fld_19A_A* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_19A_A.fld); }
                       fld_70a_A* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_70a_A.fld); }
                       seq_A3* { $elem.mutable_objects()->Add()->mutable_sequence()->MergeFrom($seq_A3.elem); }
...
seq_A3                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("A3"); } :
                       fld_16R_A3 { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_16R_A3.fld); }
                       fld_13a_A3? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_13a_A3.fld); }
                       fld_20C_A3 { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_20C_A3.fld); }
                       fld_16S_A3 { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_16S_A3.fld); }
                       ;
...
seq_D                  returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("D"); } :
                       ...
                       fld_70D_D? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_70D_D.fld); }
...
fld_19A_A              returns [message::definition::swift::mt::Field fld]  :
                       fld_19A_A_A { $fld.MergeFrom($fld_19A_A_A.fld); }
                       ;

fld_70a_A              returns [message::definition::swift::mt::Field fld]  :
                         fld_70a_A_D { $fld.MergeFrom($fld_70a_A_D.fld); }
                       | fld_70a_A_E { $fld.MergeFrom($fld_70a_A_E.fld); }
                       ;

fld_16R_A3             returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("16R"); } : 
                       START_OF_FIELD '16R:' ~(START_OF_FIELD)+;

fld_13a_A3             returns [message::definition::swift::mt::Field fld]  :
                         fld_13a_A3_A { $fld.MergeFrom($fld_13a_A3_A.fld); }
                       | fld_13a_A3_B { $fld.MergeFrom($fld_13a_A3_B.fld); }
                       ;

fld_20C_A3             returns [message::definition::swift::mt::Field fld]  :
                       fld_20C_A3_C { $fld.MergeFrom($fld_20C_A3_C.fld); }
                       ;

fld_16S_A3             returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("16S"); } : 
                       START_OF_FIELD '16S:' ~(START_OF_FIELD)+;
...
fld_70D_D              returns [message::definition::swift::mt::Field fld]  :
                       fld_70D_D_D { $fld.MergeFrom($fld_70D_D_D.fld); }
                       ;
...
fld_19A_A_A            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("19A"); }:
                       START_OF_FIELD '19A:' ~(START_OF_FIELD)+ ;

fld_70a_A_D            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70D"); }:
                       START_OF_FIELD '70D:' ~(START_OF_FIELD)+ ;
fld_70a_A_E            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70E"); }:
                       START_OF_FIELD '70E:' ~(START_OF_FIELD)+ ;

fld_13a_A3_A           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("13A"); }:
                       START_OF_FIELD '13A:' ~(START_OF_FIELD)+ ;
fld_13a_A3_B           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("13B"); }:
                       START_OF_FIELD '13B:' ~(START_OF_FIELD)+ ;

fld_20C_A3_C           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("20C"); }:
                       START_OF_FIELD '20C:' ~(START_OF_FIELD)+ ;
...
fld_70D_D_D            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70D"); }:
                       START_OF_FIELD '70D:' ~(START_OF_FIELD)+ ;
