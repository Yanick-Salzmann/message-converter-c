...
class  SwiftMtParser_MT798Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT798Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT798Parser();
  ...
  public:
      typedef SwiftMtParser_MT798Lexer tLexer;
      typedef SwiftMtParser_MT798Parser tParser;
