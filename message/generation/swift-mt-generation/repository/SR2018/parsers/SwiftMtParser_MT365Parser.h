...
class  SwiftMtParser_MT365Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT365Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT365Parser();
  ...
  public:
      typedef SwiftMtParser_MT365Lexer tLexer;
      typedef SwiftMtParser_MT365Parser tParser;
