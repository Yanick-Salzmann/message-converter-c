...
class  SwiftMtParser_MT107Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT107Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT107Parser();
  ...
  public:
      typedef SwiftMtParser_MT107Lexer tLexer;
      typedef SwiftMtParser_MT107Parser tParser;
