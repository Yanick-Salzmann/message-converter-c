...
class  SwiftMtParser_MT747Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT747Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT747Parser();
  ...
  public:
      typedef SwiftMtParser_MT747Lexer tLexer;
      typedef SwiftMtParser_MT747Parser tParser;
