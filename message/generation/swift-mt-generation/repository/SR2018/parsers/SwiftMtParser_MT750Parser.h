...
class  SwiftMtParser_MT750Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT750Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT750Parser();
  ...
  public:
      typedef SwiftMtParser_MT750Lexer tLexer;
      typedef SwiftMtParser_MT750Parser tParser;
