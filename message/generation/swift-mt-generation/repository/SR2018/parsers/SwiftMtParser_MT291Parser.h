...
class  SwiftMtParser_MT291Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT291Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT291Parser();
  ...
  public:
      typedef SwiftMtParser_MT291Lexer tLexer;
      typedef SwiftMtParser_MT291Parser tParser;
