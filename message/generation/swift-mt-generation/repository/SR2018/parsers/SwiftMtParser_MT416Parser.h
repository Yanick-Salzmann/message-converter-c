...
class  SwiftMtParser_MT416Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT416Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT416Parser();
  ...
  public:
      typedef SwiftMtParser_MT416Lexer tLexer;
      typedef SwiftMtParser_MT416Parser tParser;
