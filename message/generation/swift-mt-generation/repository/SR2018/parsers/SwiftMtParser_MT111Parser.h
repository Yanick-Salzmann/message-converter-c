...
class  SwiftMtParser_MT111Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT111Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT111Parser();
  ...
  public:
      typedef SwiftMtParser_MT111Lexer tLexer;
      typedef SwiftMtParser_MT111Parser tParser;
