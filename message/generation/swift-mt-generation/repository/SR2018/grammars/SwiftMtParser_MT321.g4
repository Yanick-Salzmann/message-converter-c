...
seq_B3                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B3"); } :
                       ...
                       fld_95a_B3+ { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_95a_B3.fld); }
...
fld_95a_B3             returns [message::definition::swift::mt::Field fld]  :
                         fld_95a_B3_P { $fld.MergeFrom($fld_95a_B3_P.fld); }
                       | fld_95a_B3_Q { $fld.MergeFrom($fld_95a_B3_Q.fld); }
                       | fld_95a_B3_R { $fld.MergeFrom($fld_95a_B3_R.fld); }
                       ;
...
fld_95a_B3_P           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95P"); }:
                       START_OF_FIELD '95P:' ~(START_OF_FIELD)+ ;
fld_95a_B3_Q           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95Q"); }:
                       START_OF_FIELD '95Q:' ~(START_OF_FIELD)+ ;
fld_95a_B3_R           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95R"); }:
                       START_OF_FIELD '95R:' ~(START_OF_FIELD)+ ;
