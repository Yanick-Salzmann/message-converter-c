...
class  SwiftMtParser_MT768Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT768Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT768Parser();
  ...
  public:
      typedef SwiftMtParser_MT768Lexer tLexer;
      typedef SwiftMtParser_MT768Parser tParser;
