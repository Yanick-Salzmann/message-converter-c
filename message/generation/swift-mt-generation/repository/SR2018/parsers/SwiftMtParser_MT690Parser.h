...
class  SwiftMtParser_MT690Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT690Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT690Parser();
  ...
  public:
      typedef SwiftMtParser_MT690Lexer tLexer;
      typedef SwiftMtParser_MT690Parser tParser;
