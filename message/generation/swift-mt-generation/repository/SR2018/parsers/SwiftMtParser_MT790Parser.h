...
class  SwiftMtParser_MT790Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT790Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT790Parser();
  ...
  public:
      typedef SwiftMtParser_MT790Lexer tLexer;
      typedef SwiftMtParser_MT790Parser tParser;
