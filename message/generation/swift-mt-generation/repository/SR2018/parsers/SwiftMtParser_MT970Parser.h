...
class  SwiftMtParser_MT970Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT970Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT970Parser();
  ...
  public:
      typedef SwiftMtParser_MT970Lexer tLexer;
      typedef SwiftMtParser_MT970Parser tParser;
