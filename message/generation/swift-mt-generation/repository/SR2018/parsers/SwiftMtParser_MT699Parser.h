...
class  SwiftMtParser_MT699Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT699Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT699Parser();
  ...
  public:
      typedef SwiftMtParser_MT699Lexer tLexer;
      typedef SwiftMtParser_MT699Parser tParser;
