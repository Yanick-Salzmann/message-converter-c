...
class  SwiftMtParser_MTn92Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MTn92Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MTn92Parser();
  ...
  public:
      typedef SwiftMtParser_MTn92Lexer tLexer;
      typedef SwiftMtParser_MTn92Parser tParser;
