...
class  SwiftMtParser_MT991Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT991Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT991Parser();
  ...
  public:
      typedef SwiftMtParser_MT991Lexer tLexer;
      typedef SwiftMtParser_MT991Parser tParser;
