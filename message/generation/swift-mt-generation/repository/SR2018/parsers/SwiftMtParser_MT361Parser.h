...
class  SwiftMtParser_MT361Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT361Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT361Parser();
  ...
  public:
      typedef SwiftMtParser_MT361Lexer tLexer;
      typedef SwiftMtParser_MT361Parser tParser;
