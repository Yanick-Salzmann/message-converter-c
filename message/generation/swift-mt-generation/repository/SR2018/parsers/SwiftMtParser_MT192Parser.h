...
class  SwiftMtParser_MT192Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT192Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT192Parser();
  ...
  public:
      typedef SwiftMtParser_MT192Lexer tLexer;
      typedef SwiftMtParser_MT192Parser tParser;
