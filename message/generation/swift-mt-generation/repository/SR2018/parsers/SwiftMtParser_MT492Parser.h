...
class  SwiftMtParser_MT492Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT492Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT492Parser();
  ...
  public:
      typedef SwiftMtParser_MT492Lexer tLexer;
      typedef SwiftMtParser_MT492Parser tParser;
