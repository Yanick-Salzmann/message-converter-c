...
class  SwiftMtParser_MT695Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT695Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT695Parser();
  ...
  public:
      typedef SwiftMtParser_MT695Lexer tLexer;
      typedef SwiftMtParser_MT695Parser tParser;
