...
class  SwiftMtParser_MT596Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT596Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT596Parser();
  ...
  public:
      typedef SwiftMtParser_MT596Lexer tLexer;
      typedef SwiftMtParser_MT596Parser tParser;
