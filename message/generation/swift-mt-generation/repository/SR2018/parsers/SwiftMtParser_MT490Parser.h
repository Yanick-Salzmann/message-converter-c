...
class  SwiftMtParser_MT490Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT490Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT490Parser();
  ...
  public:
      typedef SwiftMtParser_MT490Lexer tLexer;
      typedef SwiftMtParser_MT490Parser tParser;
