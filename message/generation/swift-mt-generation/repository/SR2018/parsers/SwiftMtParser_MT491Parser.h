...
class  SwiftMtParser_MT491Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT491Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT491Parser();
  ...
  public:
      typedef SwiftMtParser_MT491Lexer tLexer;
      typedef SwiftMtParser_MT491Parser tParser;
