...
class  SwiftMtParser_MT298Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT298Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT298Parser();
  ...
  public:
      typedef SwiftMtParser_MT298Lexer tLexer;
      typedef SwiftMtParser_MT298Parser tParser;
