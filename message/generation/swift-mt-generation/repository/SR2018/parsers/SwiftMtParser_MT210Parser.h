...
class  SwiftMtParser_MT210Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT210Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT210Parser();
  ...
  public:
      typedef SwiftMtParser_MT210Lexer tLexer;
      typedef SwiftMtParser_MT210Parser tParser;
