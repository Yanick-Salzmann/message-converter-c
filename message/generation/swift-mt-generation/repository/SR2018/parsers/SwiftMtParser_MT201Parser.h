...
class  SwiftMtParser_MT201Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT201Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT201Parser();
  ...
  public:
      typedef SwiftMtParser_MT201Lexer tLexer;
      typedef SwiftMtParser_MT201Parser tParser;
