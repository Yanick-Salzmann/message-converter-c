...
class  SwiftMtParser_MT292Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT292Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT292Parser();
  ...
  public:
      typedef SwiftMtParser_MT292Lexer tLexer;
      typedef SwiftMtParser_MT292Parser tParser;
