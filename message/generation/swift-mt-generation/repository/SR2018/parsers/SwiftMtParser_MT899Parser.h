...
class  SwiftMtParser_MT899Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT899Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT899Parser();
  ...
  public:
      typedef SwiftMtParser_MT899Lexer tLexer;
      typedef SwiftMtParser_MT899Parser tParser;
