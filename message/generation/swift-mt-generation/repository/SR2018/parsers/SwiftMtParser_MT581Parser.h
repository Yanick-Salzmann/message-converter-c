...
class  SwiftMtParser_MT581Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT581Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT581Parser();
  ...
  public:
      typedef SwiftMtParser_MT581Lexer tLexer;
      typedef SwiftMtParser_MT581Parser tParser;
