...
class  SwiftMtParser_MT546Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT546Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT546Parser();
  ...
  public:
      typedef SwiftMtParser_MT546Lexer tLexer;
      typedef SwiftMtParser_MT546Parser tParser;
