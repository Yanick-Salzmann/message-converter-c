...
class  SwiftMtParser_MT198Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT198Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT198Parser();
  ...
  public:
      typedef SwiftMtParser_MT198Lexer tLexer;
      typedef SwiftMtParser_MT198Parser tParser;
