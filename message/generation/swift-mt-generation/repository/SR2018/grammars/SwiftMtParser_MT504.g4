...
seq_C1a                returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("C1a"); } :
                       ...
                       fld_22a_C1a+ { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_22a_C1a.fld); }
                       ;
...
fld_22a_C1a            returns [message::definition::swift::mt::Field fld]  :
                         fld_22a_C1a_F { $fld.MergeFrom($fld_22a_C1a_F.fld); }
                       | fld_22a_C1a_H { $fld.MergeFrom($fld_22a_C1a_H.fld); }
                       ;
...
fld_22a_C1a_F          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22F"); }:
                       START_OF_FIELD '22F:' ~(START_OF_FIELD)+ ;
fld_22a_C1a_H          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22H"); }:
                       START_OF_FIELD '22H:' ~(START_OF_FIELD)+ ;
