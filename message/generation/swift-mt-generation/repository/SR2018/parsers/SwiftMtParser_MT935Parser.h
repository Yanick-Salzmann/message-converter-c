...
class  SwiftMtParser_MT935Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT935Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT935Parser();
  ...
  public:
      typedef SwiftMtParser_MT935Lexer tLexer;
      typedef SwiftMtParser_MT935Parser tParser;
