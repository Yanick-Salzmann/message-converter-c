...
class  SwiftMtParser_MT999Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT999Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT999Parser();
  ...
  public:
      typedef SwiftMtParser_MT999Lexer tLexer;
      typedef SwiftMtParser_MT999Parser tParser;
