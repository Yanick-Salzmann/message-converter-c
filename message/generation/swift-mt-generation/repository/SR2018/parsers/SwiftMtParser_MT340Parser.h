...
class  SwiftMtParser_MT340Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT340Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT340Parser();
  ...
  public:
      typedef SwiftMtParser_MT340Lexer tLexer;
      typedef SwiftMtParser_MT340Parser tParser;
