...
SwiftMtParser_MT767Lexer::SwiftMtParser_MT767Lexer(CharStream *input) : Lexer(input) {
  _interpreter = new atn::LexerATNSimulator(this, _atn, _decisionToDFA, _sharedContextCache);
}

SwiftMtParser_MT767Lexer::~SwiftMtParser_MT767Lexer() {
  delete _interpreter;
}

std::string SwiftMtParser_MT767Lexer::getGrammarFileName() const {
  return "SwiftMtParser_MT767.g4";
}

const std::vector<std::string>& SwiftMtParser_MT767Lexer::getRuleNames() const {
  return _ruleNames;
}

const std::vector<std::string>& SwiftMtParser_MT767Lexer::getChannelNames() const {
  return _channelNames;
}

const std::vector<std::string>& SwiftMtParser_MT767Lexer::getModeNames() const {
  return _modeNames;
}

const std::vector<std::string>& SwiftMtParser_MT767Lexer::getTokenNames() const {
  return _tokenNames;
}

dfa::Vocabulary& SwiftMtParser_MT767Lexer::getVocabulary() const {
  return _vocabulary;
}

const std::vector<uint16_t> SwiftMtParser_MT767Lexer::getSerializedATN() const {
  return _serializedATN;
}

const atn::ATN& SwiftMtParser_MT767Lexer::getATN() const {
  return _atn;
}
...
std::vector<dfa::DFA> SwiftMtParser_MT767Lexer::_decisionToDFA;
atn::PredictionContextCache SwiftMtParser_MT767Lexer::_sharedContextCache;

// We own the ATN which in turn owns the ATN states.
atn::ATN SwiftMtParser_MT767Lexer::_atn;
std::vector<uint16_t> SwiftMtParser_MT767Lexer::_serializedATN;

std::vector<std::string> SwiftMtParser_MT767Lexer::_ruleNames = {
  u8"TAG_BH", u8"TAG_AH", u8"TAG_UH", u8"TAG_MT", u8"TAG_TR", u8"MT_END", 
  u8"LBRACE", u8"RBRACE", u8"COLON", u8"START_OF_FIELD", u8"ANY"
};

std::vector<std::string> SwiftMtParser_MT767Lexer::_channelNames = {
  "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
};

std::vector<std::string> SwiftMtParser_MT767Lexer::_modeNames = {
  u8"DEFAULT_MODE"
};

std::vector<std::string> SwiftMtParser_MT767Lexer::_literalNames = {
  "", u8"'{1:'", u8"'{2:'", u8"'{3:'", u8"'{4:'", u8"'{5:'", u8"'-}'", u8"'{'", 
  u8"'}'", u8"':'"
};

std::vector<std::string> SwiftMtParser_MT767Lexer::_symbolicNames = {
  "", u8"TAG_BH", u8"TAG_AH", u8"TAG_UH", u8"TAG_MT", u8"TAG_TR", u8"MT_END", 
  u8"LBRACE", u8"RBRACE", u8"COLON", u8"START_OF_FIELD", u8"ANY"
};

dfa::Vocabulary SwiftMtParser_MT767Lexer::_vocabulary(_literalNames, _symbolicNames);

std::vector<std::string> SwiftMtParser_MT767Lexer::_tokenNames;

SwiftMtParser_MT767Lexer::Initializer::Initializer() {
...
SwiftMtParser_MT767Lexer::Initializer SwiftMtParser_MT767Lexer::_init;
