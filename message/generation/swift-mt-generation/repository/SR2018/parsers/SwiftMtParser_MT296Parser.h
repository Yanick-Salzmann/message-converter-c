...
class  SwiftMtParser_MT296Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT296Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT296Parser();
  ...
  public:
      typedef SwiftMtParser_MT296Lexer tLexer;
      typedef SwiftMtParser_MT296Parser tParser;
