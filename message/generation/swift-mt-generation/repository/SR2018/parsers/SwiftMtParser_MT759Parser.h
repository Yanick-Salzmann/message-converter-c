...
class  SwiftMtParser_MT759Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT759Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT759Parser();
  ...
  public:
      typedef SwiftMtParser_MT759Lexer tLexer;
      typedef SwiftMtParser_MT759Parser tParser;
