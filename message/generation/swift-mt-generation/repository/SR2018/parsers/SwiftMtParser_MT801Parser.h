...
class  SwiftMtParser_MT801Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT801Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT801Parser();
  ...
  public:
      typedef SwiftMtParser_MT801Lexer tLexer;
      typedef SwiftMtParser_MT801Parser tParser;
