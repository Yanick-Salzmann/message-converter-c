...
class  SwiftMtParser_MT900Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT900Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT900Parser();
  ...
  public:
      typedef SwiftMtParser_MT900Lexer tLexer;
      typedef SwiftMtParser_MT900Parser tParser;
