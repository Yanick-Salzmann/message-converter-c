...
class  SwiftMtParser_MT598Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT598Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT598Parser();
  ...
  public:
      typedef SwiftMtParser_MT598Lexer tLexer;
      typedef SwiftMtParser_MT598Parser tParser;
