...
class  SwiftMtParser_MT199Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT199Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT199Parser();
  ...
  public:
      typedef SwiftMtParser_MT199Lexer tLexer;
      typedef SwiftMtParser_MT199Parser tParser;
