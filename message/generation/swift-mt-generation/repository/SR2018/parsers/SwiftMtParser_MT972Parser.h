...
class  SwiftMtParser_MT972Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT972Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT972Parser();
  ...
  public:
      typedef SwiftMtParser_MT972Lexer tLexer;
      typedef SwiftMtParser_MT972Parser tParser;
