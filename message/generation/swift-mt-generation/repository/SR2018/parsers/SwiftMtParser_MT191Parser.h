...
class  SwiftMtParser_MT191Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT191Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT191Parser();
  ...
  public:
      typedef SwiftMtParser_MT191Lexer tLexer;
      typedef SwiftMtParser_MT191Parser tParser;
