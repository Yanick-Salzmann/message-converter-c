...
class  SwiftMtParser_MT195Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT195Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT195Parser();
  ...
  public:
      typedef SwiftMtParser_MT195Lexer tLexer;
      typedef SwiftMtParser_MT195Parser tParser;
