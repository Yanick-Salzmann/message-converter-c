...
class  SwiftMtParser_MT992Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT992Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT992Parser();
  ...
  public:
      typedef SwiftMtParser_MT992Lexer tLexer;
      typedef SwiftMtParser_MT992Parser tParser;
