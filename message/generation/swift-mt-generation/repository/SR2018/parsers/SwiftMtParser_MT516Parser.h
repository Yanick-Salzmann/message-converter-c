...
class  SwiftMtParser_MT516Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT516Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT516Parser();
  ...
  public:
      typedef SwiftMtParser_MT516Lexer tLexer;
      typedef SwiftMtParser_MT516Parser tParser;
