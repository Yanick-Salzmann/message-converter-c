...
class  SwiftMtParser_MT769Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT769Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT769Parser();
  ...
  public:
      typedef SwiftMtParser_MT769Lexer tLexer;
      typedef SwiftMtParser_MT769Parser tParser;
