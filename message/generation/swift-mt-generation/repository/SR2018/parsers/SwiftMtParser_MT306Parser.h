...
class  SwiftMtParser_MT306Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT306Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT306Parser();
  ...
  public:
      typedef SwiftMtParser_MT306Lexer tLexer;
      typedef SwiftMtParser_MT306Parser tParser;
