...
class  SwiftMtParser_MT341Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT341Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT341Parser();
  ...
  public:
      typedef SwiftMtParser_MT341Lexer tLexer;
      typedef SwiftMtParser_MT341Parser tParser;
