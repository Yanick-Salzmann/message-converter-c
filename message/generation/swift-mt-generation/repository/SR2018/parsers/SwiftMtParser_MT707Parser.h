...
class  SwiftMtParser_MT707Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT707Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT707Parser();
  ...
  public:
      typedef SwiftMtParser_MT707Lexer tLexer;
      typedef SwiftMtParser_MT707Parser tParser;
