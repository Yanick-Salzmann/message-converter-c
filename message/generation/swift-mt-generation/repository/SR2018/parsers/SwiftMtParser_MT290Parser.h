...
class  SwiftMtParser_MT290Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT290Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT290Parser();
  ...
  public:
      typedef SwiftMtParser_MT290Lexer tLexer;
      typedef SwiftMtParser_MT290Parser tParser;
