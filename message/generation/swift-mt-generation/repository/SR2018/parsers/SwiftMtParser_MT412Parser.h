...
class  SwiftMtParser_MT412Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT412Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT412Parser();
  ...
  public:
      typedef SwiftMtParser_MT412Lexer tLexer;
      typedef SwiftMtParser_MT412Parser tParser;
