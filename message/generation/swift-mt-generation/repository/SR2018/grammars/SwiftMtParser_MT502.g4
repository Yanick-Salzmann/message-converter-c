...
seq_B                  : fld_16R_B fld_94a_B* seq_B1* fld_22a_B+ fld_98a_B+ fld_92A_B* fld_11A_B? seq_B2+ fld_36B_B* fld_19A_B* fld_35B_B seq_B3? fld_13a_B* fld_70E_B? fld_16S_B ;
seq_B1                 : fld_16R_B1 fld_90a_B1 fld_22F_B1* fld_16S_B1 ;
seq_B2                 : fld_16R_B2 fld_95a_B2+ fld_97a_B2* fld_98a_B2? fld_20C_B2? fld_70a_B2* fld_22F_B2* fld_16S_B2 ;
seq_B3                 : fld_16R_B3 fld_94B_B3? fld_22F_B3* fld_12a_B3* fld_11A_B3? fld_98A_B3* fld_92A_B3* fld_13a_B3* fld_17B_B3* fld_90a_B3* fld_36B_B3* fld_35B_B3* fld_70E_B3? fld_16S_B3 ;
...
fld_95a_B2             : fld_95a_B2_L | fld_95a_B2_P | fld_95a_B2_Q | fld_95a_B2_R | fld_95a_B2_S ;
fld_97a_B2             : fld_97a_B2_A | fld_97a_B2_B | fld_97a_B2_E ;
fld_98a_B2             : fld_98a_B2_A | fld_98a_B2_C ;
fld_20C_B2             : fld_20C_B2_C ;
fld_70a_B2             : fld_70a_B2_C | fld_70a_B2_E ;
...
fld_94B_B3             : fld_94B_B3_B ;
fld_22F_B3             : fld_22F_B3_F ;
fld_12a_B3             : fld_12a_B3_A | fld_12a_B3_B | fld_12a_B3_C ;
fld_11A_B3             : fld_11A_B3_A ;
fld_98A_B3             : fld_98A_B3_A ;
fld_92A_B3             : fld_92A_B3_A ;
fld_13a_B3             : fld_13a_B3_A | fld_13a_B3_B ;
fld_17B_B3             : fld_17B_B3_B ;
fld_90a_B3             : fld_90a_B3_A | fld_90a_B3_B ;
fld_36B_B3             : fld_36B_B3_B ;
fld_35B_B3             : fld_35B_B3_B ;
fld_70E_B3             : fld_70E_B3_E ;
fld_16S_B3             : START_OF_FIELD '16S:' ~(START_OF_FIELD)+ ;
fld_13a_B              : fld_13a_B_A | fld_13a_B_B ;
...
fld_95a_B2_L           : START_OF_FIELD '95L:' ~(START_OF_FIELD)+ ;
...
fld_95a_B2_S           : START_OF_FIELD '95S:' ~(START_OF_FIELD)+ ;

fld_97a_B2_A           : START_OF_FIELD '97A:' ~(START_OF_FIELD)+ ;
fld_97a_B2_B           : START_OF_FIELD '97B:' ~(START_OF_FIELD)+ ;
fld_97a_B2_E           : START_OF_FIELD '97E:' ~(START_OF_FIELD)+ ;

fld_98a_B2_A           : START_OF_FIELD '98A:' ~(START_OF_FIELD)+ ;
fld_98a_B2_C           : START_OF_FIELD '98C:' ~(START_OF_FIELD)+ ;

fld_20C_B2_C           : START_OF_FIELD '20C:' ~(START_OF_FIELD)+ ;

fld_70a_B2_C           : START_OF_FIELD '70C:' ~(START_OF_FIELD)+ ;
fld_70a_B2_E           : START_OF_FIELD '70E:' ~(START_OF_FIELD)+ ;
...
fld_94B_B3_B           : START_OF_FIELD '94B:' ~(START_OF_FIELD)+ ;

fld_22F_B3_F           : START_OF_FIELD '22F:' ~(START_OF_FIELD)+ ;

fld_12a_B3_A           : START_OF_FIELD '12A:' ~(START_OF_FIELD)+ ;
fld_12a_B3_B           : START_OF_FIELD '12B:' ~(START_OF_FIELD)+ ;
fld_12a_B3_C           : START_OF_FIELD '12C:' ~(START_OF_FIELD)+ ;

fld_11A_B3_A           : START_OF_FIELD '11A:' ~(START_OF_FIELD)+ ;

fld_98A_B3_A           : START_OF_FIELD '98A:' ~(START_OF_FIELD)+ ;

fld_92A_B3_A           : START_OF_FIELD '92A:' ~(START_OF_FIELD)+ ;

fld_13a_B3_A           : START_OF_FIELD '13A:' ~(START_OF_FIELD)+ ;
fld_13a_B3_B           : START_OF_FIELD '13B:' ~(START_OF_FIELD)+ ;

fld_17B_B3_B           : START_OF_FIELD '17B:' ~(START_OF_FIELD)+ ;

fld_90a_B3_A           : START_OF_FIELD '90A:' ~(START_OF_FIELD)+ ;
fld_90a_B3_B           : START_OF_FIELD '90B:' ~(START_OF_FIELD)+ ;

fld_36B_B3_B           : START_OF_FIELD '36B:' ~(START_OF_FIELD)+ ;

fld_35B_B3_B           : START_OF_FIELD '35B:' ~(START_OF_FIELD)+ ;

fld_70E_B3_E           : START_OF_FIELD '70E:' ~(START_OF_FIELD)+ ;

fld_13a_B_A            : START_OF_FIELD '13A:' ~(START_OF_FIELD)+ ;
fld_13a_B_B            : START_OF_FIELD '13B:' ~(START_OF_FIELD)+ ;
