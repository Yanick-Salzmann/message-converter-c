...
class  SwiftMtParser_MT792Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT792Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT792Parser();
  ...
  public:
      typedef SwiftMtParser_MT792Lexer tLexer;
      typedef SwiftMtParser_MT792Parser tParser;
