...
class  SwiftMtParser_MT396Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT396Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT396Parser();
  ...
  public:
      typedef SwiftMtParser_MT396Lexer tLexer;
      typedef SwiftMtParser_MT396Parser tParser;
