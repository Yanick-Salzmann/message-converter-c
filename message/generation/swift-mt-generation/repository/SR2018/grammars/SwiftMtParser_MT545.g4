...
seq_E2                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("E2"); } :
                       ...
                       fld_20C_E2? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_20C_E2.fld); }
...
seq_E3                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("E3"); } :
                       ...
                       fld_98a_E3? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_98a_E3.fld); }
...
fld_20C_E2             returns [message::definition::swift::mt::Field fld]  :
                       fld_20C_E2_C { $fld.MergeFrom($fld_20C_E2_C.fld); }
                       ;
...
fld_98a_E3             returns [message::definition::swift::mt::Field fld]  :
                         fld_98a_E3_A { $fld.MergeFrom($fld_98a_E3_A.fld); }
                       | fld_98a_E3_C { $fld.MergeFrom($fld_98a_E3_C.fld); }
                       ;
...
fld_20C_E2_C           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("20C"); }:
                       START_OF_FIELD '20C:' ~(START_OF_FIELD)+ ;
...
fld_98a_E3_A           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("98A"); }:
                       START_OF_FIELD '98A:' ~(START_OF_FIELD)+ ;
fld_98a_E3_C           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("98C"); }:
                       START_OF_FIELD '98C:' ~(START_OF_FIELD)+ ;
