...
class  SwiftMtParser_MT499Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT499Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT499Parser();
  ...
  public:
      typedef SwiftMtParser_MT499Lexer tLexer;
      typedef SwiftMtParser_MT499Parser tParser;
