...
class  SwiftMtParser_MT890Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT890Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT890Parser();
  ...
  public:
      typedef SwiftMtParser_MT890Lexer tLexer;
      typedef SwiftMtParser_MT890Parser tParser;
