...
class  SwiftMtParser_MT740Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT740Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT740Parser();
  ...
  public:
      typedef SwiftMtParser_MT740Lexer tLexer;
      typedef SwiftMtParser_MT740Parser tParser;
