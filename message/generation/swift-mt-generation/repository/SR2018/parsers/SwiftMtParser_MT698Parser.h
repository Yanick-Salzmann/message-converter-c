...
class  SwiftMtParser_MT698Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT698Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT698Parser();
  ...
  public:
      typedef SwiftMtParser_MT698Lexer tLexer;
      typedef SwiftMtParser_MT698Parser tParser;
