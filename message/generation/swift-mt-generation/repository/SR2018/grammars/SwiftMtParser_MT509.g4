...
seq_B1                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B1"); } :
                       ...
                       fld_70a_B1* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_70a_B1.fld); }
...
fld_95a_B1             returns [message::definition::swift::mt::Field fld]  :
                         fld_95a_B1_L { $fld.MergeFrom($fld_95a_B1_L.fld); }
...
fld_97a_B1             returns [message::definition::swift::mt::Field fld]  :
                       ...
                       | fld_97a_B1_B { $fld.MergeFrom($fld_97a_B1_B.fld); }
                       | fld_97a_B1_E { $fld.MergeFrom($fld_97a_B1_E.fld); }
                       ;
...
fld_70a_B1             returns [message::definition::swift::mt::Field fld]  :
                         fld_70a_B1_C { $fld.MergeFrom($fld_70a_B1_C.fld); }
                       | fld_70a_B1_E { $fld.MergeFrom($fld_70a_B1_E.fld); }
                       ;
...
fld_95a_B1_L           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95L"); }:
                       START_OF_FIELD '95L:' ~(START_OF_FIELD)+ ;
...
fld_97a_B1_A           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("97A"); }:
                       START_OF_FIELD '97A:' ~(START_OF_FIELD)+ ;
fld_97a_B1_B           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("97B"); }:
                       START_OF_FIELD '97B:' ~(START_OF_FIELD)+ ;
fld_97a_B1_E           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("97E"); }:
...
fld_70a_B1_C           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70C"); }:
                       START_OF_FIELD '70C:' ~(START_OF_FIELD)+ ;
fld_70a_B1_E           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70E"); }:
