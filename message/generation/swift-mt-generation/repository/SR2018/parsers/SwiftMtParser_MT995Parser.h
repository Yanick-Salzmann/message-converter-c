...
class  SwiftMtParser_MT995Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT995Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT995Parser();
  ...
  public:
      typedef SwiftMtParser_MT995Lexer tLexer;
      typedef SwiftMtParser_MT995Parser tParser;
