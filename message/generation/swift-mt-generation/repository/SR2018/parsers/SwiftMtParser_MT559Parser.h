...
class  SwiftMtParser_MT559Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT559Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT559Parser();
  ...
  public:
      typedef SwiftMtParser_MT559Lexer tLexer;
      typedef SwiftMtParser_MT559Parser tParser;
