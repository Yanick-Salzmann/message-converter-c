...
class  SwiftMtParser_MT973Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT973Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT973Parser();
  ...
  public:
      typedef SwiftMtParser_MT973Lexer tLexer;
      typedef SwiftMtParser_MT973Parser tParser;
