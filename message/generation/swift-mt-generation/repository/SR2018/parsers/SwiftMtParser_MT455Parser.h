...
class  SwiftMtParser_MT455Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT455Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT455Parser();
  ...
  public:
      typedef SwiftMtParser_MT455Lexer tLexer;
      typedef SwiftMtParser_MT455Parser tParser;
