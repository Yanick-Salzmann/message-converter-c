...
class  SwiftMtParser_MT767Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT767Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT767Parser();
  ...
  public:
      typedef SwiftMtParser_MT767Lexer tLexer;
      typedef SwiftMtParser_MT767Parser tParser;
