...
class  SwiftMtParser_MT601Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT601Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT601Parser();
  ...
  public:
      typedef SwiftMtParser_MT601Lexer tLexer;
      typedef SwiftMtParser_MT601Parser tParser;
