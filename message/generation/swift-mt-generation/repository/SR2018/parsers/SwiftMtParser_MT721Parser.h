...
class  SwiftMtParser_MT721Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT721Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT721Parser();
  ...
  public:
      typedef SwiftMtParser_MT721Lexer tLexer;
      typedef SwiftMtParser_MT721Parser tParser;
