...
seq_B2                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B2"); } :
                       ...
                       fld_93B_B2? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_93B_B2.fld); }
...
fld_93B_B2             returns [message::definition::swift::mt::Field fld]  :
                       fld_93B_B2_B { $fld.MergeFrom($fld_93B_B2_B.fld); }
                       ;
...
fld_93B_B2_B           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("93B"); }:
