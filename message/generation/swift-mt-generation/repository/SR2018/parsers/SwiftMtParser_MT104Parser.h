...
class  SwiftMtParser_MT104Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT104Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT104Parser();
  ...
  public:
      typedef SwiftMtParser_MT104Lexer tLexer;
      typedef SwiftMtParser_MT104Parser tParser;
