...
class  SwiftMtParser_MT708Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT708Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT708Parser();
  ...
  public:
      typedef SwiftMtParser_MT708Lexer tLexer;
      typedef SwiftMtParser_MT708Parser tParser;
