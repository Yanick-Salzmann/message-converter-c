...
class  SwiftMtParser_MT399Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT399Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT399Parser();
  ...
  public:
      typedef SwiftMtParser_MT399Lexer tLexer;
      typedef SwiftMtParser_MT399Parser tParser;
