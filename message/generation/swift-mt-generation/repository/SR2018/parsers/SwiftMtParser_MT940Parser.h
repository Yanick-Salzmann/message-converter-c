...
class  SwiftMtParser_MT940Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT940Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT940Parser();
  ...
  public:
      typedef SwiftMtParser_MT940Lexer tLexer;
      typedef SwiftMtParser_MT940Parser tParser;
