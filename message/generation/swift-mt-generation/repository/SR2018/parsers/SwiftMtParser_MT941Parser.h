...
class  SwiftMtParser_MT941Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT941Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT941Parser();
  ...
  public:
      typedef SwiftMtParser_MT941Lexer tLexer;
      typedef SwiftMtParser_MT941Parser tParser;
