...
class  SwiftMtParser_MT824Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT824Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT824Parser();
  ...
  public:
      typedef SwiftMtParser_MT824Lexer tLexer;
      typedef SwiftMtParser_MT824Parser tParser;
