...
class  SwiftMtParser_MT606Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT606Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT606Parser();
  ...
  public:
      typedef SwiftMtParser_MT606Lexer tLexer;
      typedef SwiftMtParser_MT606Parser tParser;
