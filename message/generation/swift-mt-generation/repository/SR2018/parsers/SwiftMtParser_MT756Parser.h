...
class  SwiftMtParser_MT756Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT756Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT756Parser();
  ...
  public:
      typedef SwiftMtParser_MT756Lexer tLexer;
      typedef SwiftMtParser_MT756Parser tParser;
