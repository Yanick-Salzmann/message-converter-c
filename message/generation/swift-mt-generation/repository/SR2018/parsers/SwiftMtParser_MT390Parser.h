...
class  SwiftMtParser_MT390Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT390Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT390Parser();
  ...
  public:
      typedef SwiftMtParser_MT390Lexer tLexer;
      typedef SwiftMtParser_MT390Parser tParser;
