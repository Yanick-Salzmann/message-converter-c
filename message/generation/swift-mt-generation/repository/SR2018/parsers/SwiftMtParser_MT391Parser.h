...
class  SwiftMtParser_MT391Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT391Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT391Parser();
  ...
  public:
      typedef SwiftMtParser_MT391Lexer tLexer;
      typedef SwiftMtParser_MT391Parser tParser;
