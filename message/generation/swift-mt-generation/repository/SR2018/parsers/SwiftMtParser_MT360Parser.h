...
class  SwiftMtParser_MT360Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT360Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT360Parser();
  ...
  public:
      typedef SwiftMtParser_MT360Lexer tLexer;
      typedef SwiftMtParser_MT360Parser tParser;
