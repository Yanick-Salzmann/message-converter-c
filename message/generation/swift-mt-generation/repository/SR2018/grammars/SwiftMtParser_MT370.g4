...
seq_A                  returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("A"); } :
                       ...
                       fld_95P_A { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_95P_A.fld); }
...
seq_A2                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("A2"); } :
                       ...
                       fld_95a_A2 { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_95a_A2.fld); }
                       fld_97A_A2? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_97A_A2.fld); }
...
fld_95P_A              returns [message::definition::swift::mt::Field fld]  :
                       fld_95P_A_P { $fld.MergeFrom($fld_95P_A_P.fld); }
                       ;

fld_16R_A2             returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("16R"); } : 
                       START_OF_FIELD '16R:' ~(START_OF_FIELD)+;

fld_95a_A2             returns [message::definition::swift::mt::Field fld]  :
                         fld_95a_A2_P { $fld.MergeFrom($fld_95a_A2_P.fld); }
                       | fld_95a_A2_Q { $fld.MergeFrom($fld_95a_A2_Q.fld); }
                       | fld_95a_A2_R { $fld.MergeFrom($fld_95a_A2_R.fld); }
                       ;

fld_97A_A2             returns [message::definition::swift::mt::Field fld]  :
                       fld_97A_A2_A { $fld.MergeFrom($fld_97A_A2_A.fld); }
                       ;
...
fld_99a_B              returns [message::definition::swift::mt::Field fld]  :
                       ...
                       | fld_99a_B_C { $fld.MergeFrom($fld_99a_B_C.fld); }
                       ;
...
fld_95P_A_P            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95P"); }:
                       START_OF_FIELD '95P:' ~(START_OF_FIELD)+ ;

fld_95a_A2_P           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95P"); }:
                       START_OF_FIELD '95P:' ~(START_OF_FIELD)+ ;
fld_95a_A2_Q           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95Q"); }:
                       START_OF_FIELD '95Q:' ~(START_OF_FIELD)+ ;
fld_95a_A2_R           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95R"); }:
                       START_OF_FIELD '95R:' ~(START_OF_FIELD)+ ;

fld_97A_A2_A           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("97A"); }:
...
fld_99a_B_C            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("99C"); }:
                       START_OF_FIELD '99C:' ~(START_OF_FIELD)+ ;
