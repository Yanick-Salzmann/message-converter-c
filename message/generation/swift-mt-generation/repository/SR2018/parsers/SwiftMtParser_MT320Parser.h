...
class  SwiftMtParser_MT320Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT320Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT320Parser();
  ...
  public:
      typedef SwiftMtParser_MT320Lexer tLexer;
      typedef SwiftMtParser_MT320Parser tParser;
