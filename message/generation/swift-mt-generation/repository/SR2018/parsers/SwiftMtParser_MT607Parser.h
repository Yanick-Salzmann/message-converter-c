...
class  SwiftMtParser_MT607Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT607Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT607Parser();
  ...
  public:
      typedef SwiftMtParser_MT607Lexer tLexer;
      typedef SwiftMtParser_MT607Parser tParser;
