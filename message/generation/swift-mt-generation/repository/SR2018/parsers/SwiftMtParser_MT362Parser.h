...
class  SwiftMtParser_MT362Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT362Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT362Parser();
  ...
  public:
      typedef SwiftMtParser_MT362Lexer tLexer;
      typedef SwiftMtParser_MT362Parser tParser;
