...
class  SwiftMtParser_MT102Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT102Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT102Parser();
  ...
  public:
      typedef SwiftMtParser_MT102Lexer tLexer;
      typedef SwiftMtParser_MT102Parser tParser;
