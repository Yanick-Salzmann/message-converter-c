...
int main(int argc, const char *argv[]) {
    ...
    const auto defn = repo.message_definition("564");
    ...
    const auto ret = env.render(inja_template, nlohmann::json{{"message_type", "564"}});

    std::ofstream os("SwiftMtParser_MT564.g4", std::ios::out | std::ios::binary);
