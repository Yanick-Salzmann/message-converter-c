...
class  SwiftMtParser_MT898Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT898Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT898Parser();
  ...
  public:
      typedef SwiftMtParser_MT898Lexer tLexer;
      typedef SwiftMtParser_MT898Parser tParser;
