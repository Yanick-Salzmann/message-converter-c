...
class  SwiftMtParser_MT392Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT392Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT392Parser();
  ...
  public:
      typedef SwiftMtParser_MT392Lexer tLexer;
      typedef SwiftMtParser_MT392Parser tParser;
