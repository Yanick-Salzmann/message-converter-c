...
class  SwiftMtParser_MT691Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT691Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT691Parser();
  ...
  public:
      typedef SwiftMtParser_MT691Lexer tLexer;
      typedef SwiftMtParser_MT691Parser tParser;
