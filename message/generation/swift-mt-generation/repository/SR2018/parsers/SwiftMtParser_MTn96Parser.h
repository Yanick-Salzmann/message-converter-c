...
class  SwiftMtParser_MTn96Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MTn96Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MTn96Parser();
  ...
  public:
      typedef SwiftMtParser_MTn96Lexer tLexer;
      typedef SwiftMtParser_MTn96Parser tParser;
