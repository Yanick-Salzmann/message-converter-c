...
class  SwiftMtParser_MT732Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT732Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT732Parser();
  ...
  public:
      typedef SwiftMtParser_MT732Lexer tLexer;
      typedef SwiftMtParser_MT732Parser tParser;
