...
seq_A                  returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("A"); } :
                       ...
                       fld_24B_A? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_24B_A.fld); }
...
seq_B                  returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B"); } :
                       ...
                       fld_24B_B? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_24B_B.fld); }
                       fld_70D_B? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_70D_B.fld); }
...
fld_24B_A              returns [message::definition::swift::mt::Field fld]  :
                       fld_24B_A_B { $fld.MergeFrom($fld_24B_A_B.fld); }
                       ;

fld_70a_A              returns [message::definition::swift::mt::Field fld]  :
                         fld_70a_A_C { $fld.MergeFrom($fld_70a_A_C.fld); }
...
fld_24B_B              returns [message::definition::swift::mt::Field fld]  :
                       fld_24B_B_B { $fld.MergeFrom($fld_24B_B_B.fld); }
                       ;

fld_70D_B              returns [message::definition::swift::mt::Field fld]  :
                       fld_70D_B_D { $fld.MergeFrom($fld_70D_B_D.fld); }
                       ;
...
fld_24B_A_B            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("24B"); }:
                       START_OF_FIELD '24B:' ~(START_OF_FIELD)+ ;

fld_70a_A_C            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70C"); }:
                       START_OF_FIELD '70C:' ~(START_OF_FIELD)+ ;
...
fld_24B_B_B            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("24B"); }:
                       START_OF_FIELD '24B:' ~(START_OF_FIELD)+ ;

fld_70D_B_D            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70D"); }:
                       START_OF_FIELD '70D:' ~(START_OF_FIELD)+ ;
