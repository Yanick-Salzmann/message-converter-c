...
class  SwiftMtParser_MT730Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT730Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT730Parser();
  ...
  public:
      typedef SwiftMtParser_MT730Lexer tLexer;
      typedef SwiftMtParser_MT730Parser tParser;
