...
class  SwiftMtParser_MT196Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT196Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT196Parser();
  ...
  public:
      typedef SwiftMtParser_MT196Lexer tLexer;
      typedef SwiftMtParser_MT196Parser tParser;
