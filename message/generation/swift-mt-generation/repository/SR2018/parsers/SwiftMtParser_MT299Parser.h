...
class  SwiftMtParser_MT299Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT299Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT299Parser();
  ...
  public:
      typedef SwiftMtParser_MT299Lexer tLexer;
      typedef SwiftMtParser_MT299Parser tParser;
