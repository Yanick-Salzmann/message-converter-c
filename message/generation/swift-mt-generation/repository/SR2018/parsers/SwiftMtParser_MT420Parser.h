...
class  SwiftMtParser_MT420Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT420Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT420Parser();
  ...
  public:
      typedef SwiftMtParser_MT420Lexer tLexer;
      typedef SwiftMtParser_MT420Parser tParser;
