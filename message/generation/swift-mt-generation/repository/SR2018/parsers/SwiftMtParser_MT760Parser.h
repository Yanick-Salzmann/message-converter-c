...
class  SwiftMtParser_MT760Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT760Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT760Parser();
  ...
  public:
      typedef SwiftMtParser_MT760Lexer tLexer;
      typedef SwiftMtParser_MT760Parser tParser;
