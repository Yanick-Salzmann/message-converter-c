...
class  SwiftMtParser_MT985Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT985Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT985Parser();
  ...
  public:
      typedef SwiftMtParser_MT985Lexer tLexer;
      typedef SwiftMtParser_MT985Parser tParser;
