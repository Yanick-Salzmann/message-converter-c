...
class  SwiftMtParser_MT802Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT802Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT802Parser();
  ...
  public:
      typedef SwiftMtParser_MT802Lexer tLexer;
      typedef SwiftMtParser_MT802Parser tParser;
