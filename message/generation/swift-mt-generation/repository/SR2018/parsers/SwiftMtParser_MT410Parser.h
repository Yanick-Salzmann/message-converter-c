...
class  SwiftMtParser_MT410Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT410Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT410Parser();
  ...
  public:
      typedef SwiftMtParser_MT410Lexer tLexer;
      typedef SwiftMtParser_MT410Parser tParser;
