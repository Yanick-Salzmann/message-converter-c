...
class  SwiftMtParser_MT496Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT496Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT496Parser();
  ...
  public:
      typedef SwiftMtParser_MT496Lexer tLexer;
      typedef SwiftMtParser_MT496Parser tParser;
