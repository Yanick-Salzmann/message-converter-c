...
class  SwiftMtParser_MT526Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT526Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT526Parser();
  ...
  public:
      typedef SwiftMtParser_MT526Lexer tLexer;
      typedef SwiftMtParser_MT526Parser tParser;
