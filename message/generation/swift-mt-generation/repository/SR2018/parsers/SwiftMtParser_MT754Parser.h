...
class  SwiftMtParser_MT754Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT754Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT754Parser();
  ...
  public:
      typedef SwiftMtParser_MT754Lexer tLexer;
      typedef SwiftMtParser_MT754Parser tParser;
