...
class  SwiftMtParser_MT592Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT592Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT592Parser();
  ...
  public:
      typedef SwiftMtParser_MT592Lexer tLexer;
      typedef SwiftMtParser_MT592Parser tParser;
