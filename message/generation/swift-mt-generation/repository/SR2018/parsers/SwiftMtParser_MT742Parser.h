...
class  SwiftMtParser_MT742Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT742Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT742Parser();
  ...
  public:
      typedef SwiftMtParser_MT742Lexer tLexer;
      typedef SwiftMtParser_MT742Parser tParser;
