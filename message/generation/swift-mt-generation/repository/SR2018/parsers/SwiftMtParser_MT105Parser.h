...
class  SwiftMtParser_MT105Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT105Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT105Parser();
  ...
  public:
      typedef SwiftMtParser_MT105Lexer tLexer;
      typedef SwiftMtParser_MT105Parser tParser;
