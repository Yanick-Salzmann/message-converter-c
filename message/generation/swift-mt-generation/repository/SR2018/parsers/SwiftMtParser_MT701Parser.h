...
class  SwiftMtParser_MT701Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT701Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT701Parser();
  ...
  public:
      typedef SwiftMtParser_MT701Lexer tLexer;
      typedef SwiftMtParser_MT701Parser tParser;
