...
class  SwiftMtParser_MT400Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT400Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT400Parser();
  ...
  public:
      typedef SwiftMtParser_MT400Lexer tLexer;
      typedef SwiftMtParser_MT400Parser tParser;
