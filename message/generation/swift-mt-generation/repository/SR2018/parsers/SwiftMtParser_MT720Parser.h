...
class  SwiftMtParser_MT720Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT720Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT720Parser();
  ...
  public:
      typedef SwiftMtParser_MT720Lexer tLexer;
      typedef SwiftMtParser_MT720Parser tParser;
