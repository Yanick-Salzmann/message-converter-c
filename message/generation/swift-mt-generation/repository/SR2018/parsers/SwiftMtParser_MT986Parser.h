...
class  SwiftMtParser_MT986Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT986Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT986Parser();
  ...
  public:
      typedef SwiftMtParser_MT986Lexer tLexer;
      typedef SwiftMtParser_MT986Parser tParser;
