...
class  SwiftMtParser_MT744Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT744Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT744Parser();
  ...
  public:
      typedef SwiftMtParser_MT744Lexer tLexer;
      typedef SwiftMtParser_MT744Parser tParser;
