...
class  SwiftMtParser_MT591Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT591Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT591Parser();
  ...
  public:
      typedef SwiftMtParser_MT591Lexer tLexer;
      typedef SwiftMtParser_MT591Parser tParser;
