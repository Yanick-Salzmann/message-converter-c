...
class  SwiftMtParser_MT430Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT430Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT430Parser();
  ...
  public:
      typedef SwiftMtParser_MT430Lexer tLexer;
      typedef SwiftMtParser_MT430Parser tParser;
