...
class  SwiftMtParser_MT112Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT112Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT112Parser();
  ...
  public:
      typedef SwiftMtParser_MT112Lexer tLexer;
      typedef SwiftMtParser_MT112Parser tParser;
