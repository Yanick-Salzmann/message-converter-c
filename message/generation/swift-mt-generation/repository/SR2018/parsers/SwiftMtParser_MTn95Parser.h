...
class  SwiftMtParser_MTn95Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MTn95Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MTn95Parser();
  ...
  public:
      typedef SwiftMtParser_MTn95Lexer tLexer;
      typedef SwiftMtParser_MTn95Parser tParser;
