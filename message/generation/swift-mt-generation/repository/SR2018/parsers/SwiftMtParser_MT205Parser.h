...
class  SwiftMtParser_MT205Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT205Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT205Parser();
  ...
  public:
      typedef SwiftMtParser_MT205Lexer tLexer;
      typedef SwiftMtParser_MT205Parser tParser;
