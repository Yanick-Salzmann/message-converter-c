...
seq_C                  : fld_16R_C fld_20C_C fld_22a_C+ fld_98A_C? seq_C1? seq_C2? seq_C3? fld_16S_C ;
seq_C1                 : fld_16R_C1 fld_35B_C1 fld_36B_C1 fld_17B_C1? fld_16S_C1 ;
seq_C2                 : fld_16R_C2 fld_19B_C2 fld_22H_C2 fld_98A_C2? fld_16S_C2 ;
seq_C3                 : fld_16R_C3 fld_22H_C3 fld_98a_C3+ fld_95a_C3 fld_19B_C3 fld_16S_C3 ;
...
fld_22H_C2             : fld_22H_C2_H ;
fld_98A_C2             : fld_98A_C2_A ;
fld_16S_C2             : START_OF_FIELD '16S:' ~(START_OF_FIELD)+ ;
fld_16R_C3             : START_OF_FIELD '16R:' ~(START_OF_FIELD)+ ;
fld_22H_C3             : fld_22H_C3_H ;
fld_98a_C3             : fld_98a_C3_A | fld_98a_C3_B ;
fld_95a_C3             : fld_95a_C3_P | fld_95a_C3_Q | fld_95a_C3_R ;
...
fld_22H_C2_H           : START_OF_FIELD '22H:' ~(START_OF_FIELD)+ ;

fld_98A_C2_A           : START_OF_FIELD '98A:' ~(START_OF_FIELD)+ ;

fld_22H_C3_H           : START_OF_FIELD '22H:' ~(START_OF_FIELD)+ ;

fld_98a_C3_A           : START_OF_FIELD '98A:' ~(START_OF_FIELD)+ ;
fld_98a_C3_B           : START_OF_FIELD '98B:' ~(START_OF_FIELD)+ ;

fld_95a_C3_P           : START_OF_FIELD '95P:' ~(START_OF_FIELD)+ ;
fld_95a_C3_Q           : START_OF_FIELD '95Q:' ~(START_OF_FIELD)+ ;
fld_95a_C3_R           : START_OF_FIELD '95R:' ~(START_OF_FIELD)+ ;
