...
class  SwiftMtParser_MT350Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT350Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT350Parser();
  ...
  public:
      typedef SwiftMtParser_MT350Lexer tLexer;
      typedef SwiftMtParser_MT350Parser tParser;
