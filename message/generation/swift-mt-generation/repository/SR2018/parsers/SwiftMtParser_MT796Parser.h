...
class  SwiftMtParser_MT796Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT796Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT796Parser();
  ...
  public:
      typedef SwiftMtParser_MT796Lexer tLexer;
      typedef SwiftMtParser_MT796Parser tParser;
