...
class  SwiftMtParser_MT200Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT200Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT200Parser();
  ...
  public:
      typedef SwiftMtParser_MT200Lexer tLexer;
      typedef SwiftMtParser_MT200Parser tParser;
