...
class  SwiftMtParser_MT971Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT971Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT971Parser();
  ...
  public:
      typedef SwiftMtParser_MT971Lexer tLexer;
      typedef SwiftMtParser_MT971Parser tParser;
