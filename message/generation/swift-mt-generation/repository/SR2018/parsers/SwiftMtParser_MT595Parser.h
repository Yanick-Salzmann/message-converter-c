...
class  SwiftMtParser_MT595Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT595Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT595Parser();
  ...
  public:
      typedef SwiftMtParser_MT595Lexer tLexer;
      typedef SwiftMtParser_MT595Parser tParser;
