...
seq_A2                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("A2"); } :
                       ...
                       fld_95P_A2* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_95P_A2.fld); }
                       fld_94C_A2* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_94C_A2.fld); }
                       fld_22H_A2? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_22H_A2.fld); }
...
seq_B2                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B2"); } :
                       ...
                       fld_22H_B2? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_22H_B2.fld); }
...
fld_95P_A2             returns [message::definition::swift::mt::Field fld]  :
                       fld_95P_A2_P { $fld.MergeFrom($fld_95P_A2_P.fld); }
                       ;

fld_94C_A2             returns [message::definition::swift::mt::Field fld]  :
                       fld_94C_A2_C { $fld.MergeFrom($fld_94C_A2_C.fld); }
                       ;

fld_22H_A2             returns [message::definition::swift::mt::Field fld]  :
                       fld_22H_A2_H { $fld.MergeFrom($fld_22H_A2_H.fld); }
                       ;
...
fld_95a_B1             returns [message::definition::swift::mt::Field fld]  :
                       ...
                       | fld_95a_B1_S { $fld.MergeFrom($fld_95a_B1_S.fld); }
                       ;
...
fld_22H_B2             returns [message::definition::swift::mt::Field fld]  :
                       fld_22H_B2_H { $fld.MergeFrom($fld_22H_B2_H.fld); }
                       ;
...
fld_95P_A2_P           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95P"); }:
                       START_OF_FIELD '95P:' ~(START_OF_FIELD)+ ;

fld_94C_A2_C           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("94C"); }:
                       START_OF_FIELD '94C:' ~(START_OF_FIELD)+ ;

fld_22H_A2_H           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22H"); }:
...
fld_95a_B1_S           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95S"); }:
...
fld_22H_B2_H           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22H"); }:
                       START_OF_FIELD '22H:' ~(START_OF_FIELD)+ ;
