...
class  SwiftMtParser_MT942Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT942Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT942Parser();
  ...
  public:
      typedef SwiftMtParser_MT942Lexer tLexer;
      typedef SwiftMtParser_MT942Parser tParser;
