...
class  SwiftMtParser_MT330Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT330Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT330Parser();
  ...
  public:
      typedef SwiftMtParser_MT330Lexer tLexer;
      typedef SwiftMtParser_MT330Parser tParser;
