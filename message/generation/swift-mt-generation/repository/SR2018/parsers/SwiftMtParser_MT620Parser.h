...
class  SwiftMtParser_MT620Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT620Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT620Parser();
  ...
  public:
      typedef SwiftMtParser_MT620Lexer tLexer;
      typedef SwiftMtParser_MT620Parser tParser;
