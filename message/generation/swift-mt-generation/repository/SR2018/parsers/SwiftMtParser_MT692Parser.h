...
class  SwiftMtParser_MT692Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT692Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT692Parser();
  ...
  public:
      typedef SwiftMtParser_MT692Lexer tLexer;
      typedef SwiftMtParser_MT692Parser tParser;
