...
class  SwiftMtParser_MT495Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT495Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT495Parser();
  ...
  public:
      typedef SwiftMtParser_MT495Lexer tLexer;
      typedef SwiftMtParser_MT495Parser tParser;
