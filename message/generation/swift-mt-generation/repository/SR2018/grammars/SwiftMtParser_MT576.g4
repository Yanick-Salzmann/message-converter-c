...
seq_B2                 returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B2"); } :
                       ...
                       fld_19A_B2* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_19A_B2.fld); }
                       ...
                       fld_22a_B2+ { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_22a_B2.fld); }
                       fld_98a_B2* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_98a_B2.fld); }
                       seq_B2c* { $elem.mutable_objects()->Add()->mutable_sequence()->MergeFrom($seq_B2c.elem); }
...
seq_B2b                returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B2b"); } :
                       ...
                       fld_90a_B2b { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_90a_B2b.fld); }
                       fld_22F_B2b? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_22F_B2b.fld); }
                       fld_16S_B2b { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_16S_B2b.fld); }
                       ;

seq_B2c                returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B2c"); } :
                       fld_16R_B2c { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_16R_B2c.fld); }
                       fld_95a_B2c+ { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_95a_B2c.fld); }
                       fld_97a_B2c? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_97a_B2c.fld); }
                       fld_98a_B2c? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_98a_B2c.fld); }
                       fld_20C_B2c? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_20C_B2c.fld); }
                       fld_70a_B2c* { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_70a_B2c.fld); }
                       fld_22F_B2c? { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_22F_B2c.fld); }
                       fld_16S_B2c { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_16S_B2c.fld); }
                       ;
...
fld_19A_B2             returns [message::definition::swift::mt::Field fld]  :
                       fld_19A_B2_A { $fld.MergeFrom($fld_19A_B2_A.fld); }
                       ;
...
fld_90a_B2b            returns [message::definition::swift::mt::Field fld]  :
                         fld_90a_B2b_A { $fld.MergeFrom($fld_90a_B2b_A.fld); }
                       | fld_90a_B2b_B { $fld.MergeFrom($fld_90a_B2b_B.fld); }
                       ;

fld_22F_B2b            returns [message::definition::swift::mt::Field fld]  :
                       fld_22F_B2b_F { $fld.MergeFrom($fld_22F_B2b_F.fld); }
                       ;

fld_16S_B2b            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("16S"); } : 
                       START_OF_FIELD '16S:' ~(START_OF_FIELD)+;

fld_22a_B2             returns [message::definition::swift::mt::Field fld]  :
                         fld_22a_B2_F { $fld.MergeFrom($fld_22a_B2_F.fld); }
                       | fld_22a_B2_H { $fld.MergeFrom($fld_22a_B2_H.fld); }
                       ;

fld_16R_B2c            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("16R"); } : 
                       START_OF_FIELD '16R:' ~(START_OF_FIELD)+;

fld_95a_B2c            returns [message::definition::swift::mt::Field fld]  :
                         fld_95a_B2c_L { $fld.MergeFrom($fld_95a_B2c_L.fld); }
                       | fld_95a_B2c_P { $fld.MergeFrom($fld_95a_B2c_P.fld); }
                       | fld_95a_B2c_Q { $fld.MergeFrom($fld_95a_B2c_Q.fld); }
                       | fld_95a_B2c_R { $fld.MergeFrom($fld_95a_B2c_R.fld); }
                       | fld_95a_B2c_S { $fld.MergeFrom($fld_95a_B2c_S.fld); }
                       ;

fld_97a_B2c            returns [message::definition::swift::mt::Field fld]  :
                         fld_97a_B2c_A { $fld.MergeFrom($fld_97a_B2c_A.fld); }
                       | fld_97a_B2c_B { $fld.MergeFrom($fld_97a_B2c_B.fld); }
                       ;

fld_98a_B2c            returns [message::definition::swift::mt::Field fld]  :
                         fld_98a_B2c_A { $fld.MergeFrom($fld_98a_B2c_A.fld); }
                       | fld_98a_B2c_C { $fld.MergeFrom($fld_98a_B2c_C.fld); }
                       ;

fld_20C_B2c            returns [message::definition::swift::mt::Field fld]  :
                       fld_20C_B2c_C { $fld.MergeFrom($fld_20C_B2c_C.fld); }
                       ;

fld_70a_B2c            returns [message::definition::swift::mt::Field fld]  :
                         fld_70a_B2c_C { $fld.MergeFrom($fld_70a_B2c_C.fld); }
                       | fld_70a_B2c_E { $fld.MergeFrom($fld_70a_B2c_E.fld); }
                       ;

fld_22F_B2c            returns [message::definition::swift::mt::Field fld]  :
                       fld_22F_B2c_F { $fld.MergeFrom($fld_22F_B2c_F.fld); }
                       ;

fld_16S_B2c            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("16S"); } : 
                       START_OF_FIELD '16S:' ~(START_OF_FIELD)+;
...
fld_19A_B2_A           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("19A"); }:
...
fld_90a_B2b_A          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("90A"); }:
                       START_OF_FIELD '90A:' ~(START_OF_FIELD)+ ;
fld_90a_B2b_B          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("90B"); }:
                       START_OF_FIELD '90B:' ~(START_OF_FIELD)+ ;

fld_22F_B2b_F          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22F"); }:
                       START_OF_FIELD '22F:' ~(START_OF_FIELD)+ ;

fld_22a_B2_F           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22F"); }:
                       START_OF_FIELD '22F:' ~(START_OF_FIELD)+ ;
fld_22a_B2_H           returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22H"); }:
                       START_OF_FIELD '22H:' ~(START_OF_FIELD)+ ;

fld_95a_B2c_L          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95L"); }:
                       START_OF_FIELD '95L:' ~(START_OF_FIELD)+ ;
fld_95a_B2c_P          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95P"); }:
                       START_OF_FIELD '95P:' ~(START_OF_FIELD)+ ;
fld_95a_B2c_Q          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95Q"); }:
                       START_OF_FIELD '95Q:' ~(START_OF_FIELD)+ ;
fld_95a_B2c_R          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95R"); }:
                       START_OF_FIELD '95R:' ~(START_OF_FIELD)+ ;
fld_95a_B2c_S          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("95S"); }:
                       START_OF_FIELD '95S:' ~(START_OF_FIELD)+ ;

fld_97a_B2c_A          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("97A"); }:
                       START_OF_FIELD '97A:' ~(START_OF_FIELD)+ ;
fld_97a_B2c_B          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("97B"); }:
                       START_OF_FIELD '97B:' ~(START_OF_FIELD)+ ;

fld_98a_B2c_A          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("98A"); }:
                       START_OF_FIELD '98A:' ~(START_OF_FIELD)+ ;
fld_98a_B2c_C          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("98C"); }:
                       START_OF_FIELD '98C:' ~(START_OF_FIELD)+ ;

fld_20C_B2c_C          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("20C"); }:
                       START_OF_FIELD '20C:' ~(START_OF_FIELD)+ ;

fld_70a_B2c_C          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70C"); }:
                       START_OF_FIELD '70C:' ~(START_OF_FIELD)+ ;
fld_70a_B2c_E          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70E"); }:
                       START_OF_FIELD '70E:' ~(START_OF_FIELD)+ ;

fld_22F_B2c_F          returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("22F"); }:
                       START_OF_FIELD '22F:' ~(START_OF_FIELD)+ ;
