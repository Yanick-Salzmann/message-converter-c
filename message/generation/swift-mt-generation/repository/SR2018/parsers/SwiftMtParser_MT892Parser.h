...
class  SwiftMtParser_MT892Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT892Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT892Parser();
  ...
  public:
      typedef SwiftMtParser_MT892Lexer tLexer;
      typedef SwiftMtParser_MT892Parser tParser;
