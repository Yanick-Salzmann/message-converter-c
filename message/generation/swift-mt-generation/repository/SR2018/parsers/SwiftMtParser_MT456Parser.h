...
class  SwiftMtParser_MT456Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT456Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT456Parser();
  ...
  public:
      typedef SwiftMtParser_MT456Lexer tLexer;
      typedef SwiftMtParser_MT456Parser tParser;
