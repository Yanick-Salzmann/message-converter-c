...
class  SwiftMtParser_MT450Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT450Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT450Parser();
  ...
  public:
      typedef SwiftMtParser_MT450Lexer tLexer;
      typedef SwiftMtParser_MT450Parser tParser;
