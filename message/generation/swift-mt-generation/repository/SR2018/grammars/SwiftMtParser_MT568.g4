...
seq_C                  returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("C"); } :
                       ...
                       fld_70a_C+ { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_70a_C.fld); }
...
fld_97a_B              returns [message::definition::swift::mt::Field fld]  :
                       ...
                       | fld_97a_B_C { $fld.MergeFrom($fld_97a_B_C.fld); }
                       ;
...
fld_70a_C              returns [message::definition::swift::mt::Field fld]  :
                         fld_70a_C_E { $fld.MergeFrom($fld_70a_C_E.fld); }
                       | fld_70a_C_F { $fld.MergeFrom($fld_70a_C_F.fld); }
                       ;
...
fld_97a_B_C            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("97C"); }:
...
fld_70a_C_E            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70E"); }:
                       START_OF_FIELD '70E:' ~(START_OF_FIELD)+ ;
fld_70a_C_F            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("70F"); }:
                       START_OF_FIELD '70F:' ~(START_OF_FIELD)+ ;
