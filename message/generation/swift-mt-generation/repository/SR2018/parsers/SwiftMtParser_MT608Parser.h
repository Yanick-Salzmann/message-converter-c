...
class  SwiftMtParser_MT608Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT608Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT608Parser();
  ...
  public:
      typedef SwiftMtParser_MT608Lexer tLexer;
      typedef SwiftMtParser_MT608Parser tParser;
