...
class  SwiftMtParser_MT202Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT202Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT202Parser();
  ...
  public:
      typedef SwiftMtParser_MT202Lexer tLexer;
      typedef SwiftMtParser_MT202Parser tParser;
