...
seq_B                  returns [message::definition::swift::mt::Sequence elem] @init { $elem.set_tag("B"); } :
                       ...
                       fld_92B_B { $elem.mutable_objects()->Add()->mutable_field()->MergeFrom($fld_92B_B.fld); }
...
fld_92B_B              returns [message::definition::swift::mt::Field fld]  :
                       fld_92B_B_B { $fld.MergeFrom($fld_92B_B_B.fld); }
                       ;
...
fld_92B_B_B            returns [message::definition::swift::mt::Field fld] @init { $fld.set_tag("92B"); }:
