...
class  SwiftMtParser_MT599Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT599Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT599Parser();
  ...
  public:
      typedef SwiftMtParser_MT599Lexer tLexer;
      typedef SwiftMtParser_MT599Parser tParser;
