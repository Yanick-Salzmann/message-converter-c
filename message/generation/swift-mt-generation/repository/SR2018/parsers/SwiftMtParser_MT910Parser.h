...
class  SwiftMtParser_MT910Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT910Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT910Parser();
  ...
  public:
      typedef SwiftMtParser_MT910Lexer tLexer;
      typedef SwiftMtParser_MT910Parser tParser;
