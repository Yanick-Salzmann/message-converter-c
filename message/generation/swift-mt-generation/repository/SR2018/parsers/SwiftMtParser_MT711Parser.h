...
class  SwiftMtParser_MT711Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT711Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT711Parser();
  ...
  public:
      typedef SwiftMtParser_MT711Lexer tLexer;
      typedef SwiftMtParser_MT711Parser tParser;
