...
class  SwiftMtParser_MT203Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT203Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT203Parser();
  ...
  public:
      typedef SwiftMtParser_MT203Lexer tLexer;
      typedef SwiftMtParser_MT203Parser tParser;
