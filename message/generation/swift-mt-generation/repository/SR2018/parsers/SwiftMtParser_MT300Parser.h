...
class  SwiftMtParser_MT300Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT300Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT300Parser();
  ...
  public:
      typedef SwiftMtParser_MT300Lexer tLexer;
      typedef SwiftMtParser_MT300Parser tParser;
