...
class  SwiftMtParser_MT990Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT990Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT990Parser();
  ...
  public:
      typedef SwiftMtParser_MT990Lexer tLexer;
      typedef SwiftMtParser_MT990Parser tParser;
