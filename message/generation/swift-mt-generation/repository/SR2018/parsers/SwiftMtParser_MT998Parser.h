...
class  SwiftMtParser_MT998Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT998Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT998Parser();
  ...
  public:
      typedef SwiftMtParser_MT998Lexer tLexer;
      typedef SwiftMtParser_MT998Parser tParser;
