...
class  SwiftMtParser_MTn91Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MTn91Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MTn91Parser();
  ...
  public:
      typedef SwiftMtParser_MTn91Lexer tLexer;
      typedef SwiftMtParser_MTn91Parser tParser;
