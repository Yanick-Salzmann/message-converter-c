...
class  SwiftMtParser_MT295Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT295Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT295Parser();
  ...
  public:
      typedef SwiftMtParser_MT295Lexer tLexer;
      typedef SwiftMtParser_MT295Parser tParser;
