...
class  SwiftMtParser_MT896Parser : public antlr4::Parser {
public:
  enum {
  ...
  SwiftMtParser_MT896Parser(antlr4::TokenStream *input);
  ~SwiftMtParser_MT896Parser();
  ...
  public:
      typedef SwiftMtParser_MT896Lexer tLexer;
      typedef SwiftMtParser_MT896Parser tParser;
